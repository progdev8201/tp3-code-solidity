...
async function isOwner() {
    return userAccount == (await tokenContract.methods.owner().call()).toLowerCase();
}
...
function addEventListenersToButtons() {
    ...
    if (addPickUpLineButton) {
        addPickUpLineButton.addEventListener("click", function (e) {
            renderPickUpLineForm();
        });
    }

    seePickUpLineButton.addEventListener("click", async function (e) {
